...
let HomeComponent = class HomeComponent {
    constructor(authService, userService, tasksService) {
        this.authService = authService;
    ...
    getSelectedTasks(index) {
        const selectedTask = this.userTasks.find((el, idx) => idx === index ? el : false);
        return selectedTask;
    }
    updateTaskFun(index) {
